...
class SplitCIFAR10(BaseCLDataset):
    ...
    def __init__(
        ...
        self._train_base = datasets.CIFAR10(root, train=True,  download=True, transform=_build_transforms(True))
        self._test_base  = datasets.CIFAR10(root, train=False, download=True, transform=_build_transforms(False))
