...
class SeqTinyImageNet(BaseCLDataset):
    ...
    def __init__(
        ...
        self._train_base = TinyImageNetDataset(
            root,
            "train",
            _build_transforms(True, image_size=image_size),
        )
        self._test_base  = TinyImageNetDataset(
            root,
            "val",
            _build_transforms(False, image_size=image_size),
        )
